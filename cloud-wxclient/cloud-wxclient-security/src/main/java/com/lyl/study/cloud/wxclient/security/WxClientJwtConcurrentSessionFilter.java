 ...
 */
@Slf4j
public class WxClientJwtConcurrentSessionFilter extends JwtConcurrentSessionFilter {
    // 用户管理服务
    private MemberFacade memberFacade;

    public WxClientJwtConcurrentSessionFilter(JwtSigner jwtSigner) {
        super(jwtSigner);
    }
...
//                || jwtClaims.getOpenId() == null
    ...
    public WxClientJwtConcurrentSessionFilter setMemberFacade(MemberFacade memberFacade) {
